...
impl<T, P, S, E> Debug for OnSelected<T, P, S, E>
where
    T: Debug,
{
    fn fmt(&self, formatter: &mut Formatter<'_>) -> fmt::Result {
        formatter
            .debug_struct("OnSelected")
            .field("op", &self.op)
            .finish_non_exhaustive()
    }
}

impl<T, P, S, E> Copy for OnSelected<T, P, S, E> where T: Copy {}

impl<T, P, S, E> Clone for OnSelected<T, P, S, E>
where
    T: Clone,
{
    fn clone(&self) -> Self {
...
impl<T, P, S, E> Eq for OnSelected<T, P, S, E> where T: Eq {}

impl<T, P, S, E> PartialEq for OnSelected<T, P, S, E>
where
    T: PartialEq,
{
...
impl<T, P, S, E> Hash for OnSelected<T, P, S, E>
where
    T: Hash,
{
